...
- local integration branch: `main` at consumer-checkpoint merge
  `2b4f668037ea5cc304deecf1803b4d8c87f6cd72`
...
Commit this proof update, push it to remote `main`, verify the checkpoint from
GitHub, then merge `agent/deliveryguard-publication` into canonical local
`main`. Update the cross-portfolio checkpoint before starting Printline.
